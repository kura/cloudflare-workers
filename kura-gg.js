...
const content_security_policy = [
  ...
  "style-src 'self' assets-cdn.github.com 'nonce-REPLACEMENT_NONCE' 'sha256-mAXZnIq8sghZ4KNsjSuqwTyVj2ly+bN2pB6EQd5+Yf4=';",
...
const privacy_policy = [
  ...
  "focus-without-user-activation=(), hid=(), idle-detection=(), interest-cohort=(),",
  "serial=(), sync-script=(), trust-token-redemption=(), window-placement=(),",
  "vertical-scroll=()"
].join(" ")
...
async function handle_req(request) {
  ...
  if (url.pathname == "/.well-known/security.txt") {
    let sec_txt = [
      "Contact: mailto:sec@kura.gg",
      "Expires: " + new Date(Date.now()).getFullYear() + "-12-31T00:00:00.000Z",
      "Canonical: https://kura.gg/.well-known/security.txt"
    ].join("\n")
    return new Response(sec_txt, {
      status: 200,
